...
class CreditsMenuState extends MusicBeatState
{
   ...
   [
      // Mods By //
      new Person("ayedFNF", CreditsType.mod,
      [
         new Social('youtube', 'https://youtube.com/@ayedfnf')
      ]),
     
      new Person("Ezra TigerYT", CreditsType.mod,
      [
         new Social('youtube', 'https://youtube.com/@EzraTheTigerYT'),
         new Social('gamebanana', 'https://gamebanana.com/mods/393634')
      ]),
      
      new Person("Niterhalereal", CreditsType.mod,
      [
        new Social('YouTube', 'https://youtube.com/@niter_fnf_mods_android')
      ]),
	  // Special Thanks //
